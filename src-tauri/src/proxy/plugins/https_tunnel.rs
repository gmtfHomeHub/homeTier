...
fn build_response(status: StatusCode) -> Response<crate::proxy::plugin::ResponseBody> {
    Response::builder()
        .status(status)
        ...
        let (host, port) = match parse_host_port(
            ...
            None => {
                return Ok(Response::builder()
                    ...
                    .header("content-type", "text/plain; charset=utf-8")
                    .body(crate::proxy::plugin::full_body(Bytes::from(
...
tokio::spawn(async move {
            ...
            Err(e) => {
                ...
                Ok(Response::builder()
                    ...
                    .header("content-type", "text/plain; charset=utf-8")
                    .body(crate::proxy::plugin::full_body(Bytes::from(format!(
